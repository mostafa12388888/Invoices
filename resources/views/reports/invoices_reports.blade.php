                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                ...
                                <option value="غيرمدفوع">الفواتير الغير مدفوعة</option>
                                <option value="مدفوعه جذاء منه">الفواتير المدفوعة جزئيا</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            ...
                            <input type="text" class="form-control" value="{{ $invoice_number ?? '' }}" id="invoice_number" name="invoice_number">
