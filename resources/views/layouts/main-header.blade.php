						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification" >
								...
								<div class="dropdown-menu" >
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">الاشعرات</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="/read_all">تعيين قرائه الكل</a></span>
											</a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " ><h5 id="notifications_count">عداد الاشعرات الغير مقروائه :{{auth()->user()->unreadNotifications->count()}}</h5></p>
									</div>
									<div id="unreadNotifications">
									@foreach(auth()->user()->unreadNotifications as $data)
									<div class="main-notification-list Notification-scroll" >
										
										<a class="d-flex p-3 border-bottom" href="/details-Invoices/{{$data->data['id']}}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{$data->data['title']}}{{$data->data['user']}}</h5>
												<div class="notification-subtext">انشات الفاتوره منز : {{$data->created_at}}</div>
											</div>
											<div class="mr-auto" >
									...
									<a href="/read_all">تعيين قرائه الكل</a>
									</div>
								</div>
							</div>
							@endcan
