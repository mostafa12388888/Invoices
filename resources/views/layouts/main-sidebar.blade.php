		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="side-item side-item-category" style="font-size:20px;">موقع الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoicesgroup') }}">قائمه الفواتير</a></li>
						   @endcan
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoicesnotpaid') }}">الفواتير الغير مرغوب فيه </a></li>
						    @endcan
							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='invoicespicepaid') }}">الفواتير المدفوعه جذئيه</a></li>
							@endcan
							@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='intoarchive                          ') }}">الفواتير المتارشفه</a></li>
							@endcan
						</ul>	
						</li>
					@endcan
					...
					<li class="slide">
						...
						@endcan
						@can('تقرير العملاء')
						<li><a class="slide-item" href="{{ url('/' . $page='customer_Repot') }}">تقارير العملا </a></li>
					@endcan
					</ul>
					</li>
					@endcan
