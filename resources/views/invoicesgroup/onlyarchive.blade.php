...
@endif
    ...
    <a class="dropdown-item Transfer_invoice_archive" href="#" data-invoice_id="{{ $value_invoices->id }}"
                                                        ...
                                                        الفواتير</a>
														@endcan
														@can('حذف الفاتورة')<a class="dropdown-item delete_invoice_and_retrivel" href="#" data-invoice_id="{{ $value_invoices->id }}" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('intoarchive.update', 'test') }}" method="post">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                </div>
                <div class="modal-body">
